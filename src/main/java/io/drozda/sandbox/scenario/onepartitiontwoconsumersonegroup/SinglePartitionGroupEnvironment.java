...
import io.drozda.sandbox.scenario.onepartitiontwoconsumersonegroup.app.SinglePartitionGroupCommandRequest;
import io.drozda.sandbox.scenario.onepartitiontwoconsumersonegroup.app.SinglePartitionGroupScenarioApplication;
        ...
        if (applicationContext == null) {
            ...
            applicationContext = new SpringApplicationBuilder(SinglePartitionGroupScenarioApplication.class)
                    ...
                    .run(
                            ...
                            "--spring.kafka.consumer.properties.spring.json.trusted.packages=io.drozda.sandbox.scenario.onepartitiontwoconsumersonegroup.model",
                            "--spring.kafka.consumer.properties.spring.json.value.default.type=io.drozda.sandbox.scenario.onepartitiontwoconsumersonegroup.model.GroupWorkEvent",
