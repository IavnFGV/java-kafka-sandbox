...
public class ParallelGroupConsumerA implements ConsumerSeekAware {
    public static final String LABEL = "Consumer A";
    private final ParallelGroupTracker tracker;

    public ParallelGroupConsumerA(ParallelGroupTracker tracker) { this.tracker = tracker; }

    @KafkaListener(id = "scenario-008-consumer-a", topics = "${app.kafka.topics.parallel-group}",
