...
import io.drozda.sandbox.scenario.parallelorderswithoutglobalordering.app.GlobalOrderingCommandRequest;
import io.drozda.sandbox.scenario.parallelorderswithoutglobalordering.app.GlobalOrderingMode;
import io.drozda.sandbox.scenario.parallelorderswithoutglobalordering.app.GlobalOrderingScenarioApplication;
        ...
        if (applicationContext == null) {
            ...
            applicationContext = new SpringApplicationBuilder(GlobalOrderingScenarioApplication.class)
                    ...
                    .run(
                            ...
                            "--spring.kafka.consumer.properties.spring.json.trusted.packages=io.drozda.sandbox.scenario.parallelorderswithoutglobalordering.model",
                            "--spring.kafka.consumer.properties.spring.json.value.default.type=io.drozda.sandbox.scenario.parallelorderswithoutglobalordering.model.GlobalOrderEvent",
